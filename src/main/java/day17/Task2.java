...
public class Task2 {
    public static void main(String[] args) {
        ChessPiece [][] KKboard ={{ChessPiece.ROOK_BLACK,ChessPiece.EMPTY,ChessPiece.EMPTY,ChessPiece.EMPTY,ChessPiece.EMPTY,ChessPiece.ROOK_BLACK,ChessPiece.KING_BLACK,ChessPiece.EMPTY},
        ...
        ChessBoard board = new ChessBoard(KKboard);
        board.print();
    }
}
